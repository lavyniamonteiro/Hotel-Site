...
<body>
    <!--BARRA LATERAL-->
    <aside class="sidebar">
        <h2><a href="../homepage/homepage.html" class="alta">Maré Alta</a></h2>
        <ul>
