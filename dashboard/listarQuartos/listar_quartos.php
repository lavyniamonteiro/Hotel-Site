...
<head>
    ...
    <link rel="stylesheet" href="listar_quartos.css">
</head>
...
<body>
    ...
    <aside class="sidebar">
        ...
        <ul>
            <li><a href="listar_quartos.php"><i class="fas fa-list"></i> Listar Quartos</a></li>
    ...
    <section class="main-content">
        ...
        <div class="tabela-quartos">
        <?php include 'listar_quartoss.php'; ?>
        </div>
